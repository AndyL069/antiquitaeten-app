  ...
  try {
    await prisma.item.update({
      ...
      data: {
        ...
        ebayTitle: data.ebayTitle || null,
        ebayCategory: data.ebayCategory || null,
        ebayCondition: data.ebayCondition || null,
        ebayConditionNote: data.ebayConditionNote || null,
        startPrice: data.startPrice ? parseFloat(data.startPrice) || null : null,
        buyItNowPrice: data.buyItNowPrice ? parseFloat(data.buyItNowPrice) || null : null,
